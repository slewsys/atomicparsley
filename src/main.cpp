...
static const char *shortHelp_text =
    ...
    "  Atomicparsley /path/to.mp4 --album_artist \"You\" --podcast_flag true\n"
    ...
    "  -t  --text_data    Prints tags embedded within the file\n"
    "  -E  --extract_pix  Extracts pix to the same folder as the mpeg-4 file\n"
    "\n"
    ...
    "tracks)\n"
    "  --disc         (num)[/tot]  Disk number (or disk number/total disks)\n"
    "  --comment      (string)     Set the comment tag\n"
    "  --date         (num|UTC)    Year tag (see --longhelp for \"Release "
    "Date\")\n"
    "  --lyrics       (string)     Set lyrics (not subject to 256 byte limit)\n"
    "  --lyrics_file  (/path)      Set lyrics to the content of a file\n"
    ...
    "  --album_artist (string)     Set the album artist tag\n"
    ...
    "  --tv_network   (string)     Set the TV Network name\n"
    "  --tv_show_name (string)     Set the TV Show name\n"
    "  --tv_episode   (string)     Set the TV episode/production code\n"
    "  --tv_season_num  (number)   Set the TV Season number\n"
    "  --tv_episode_num (number)   Set the TV Episode number\n"
    "  --podcast_flag (boolean)    Set the podcast flag (true or false)\n"
    "  --category     (string)     Sets the podcast category\n"
    "  --keyword      (string)     Sets the podcast keyword\n"
    "  --podcast_url  (URL)        Set the podcast feed URL\n"
    "  --podcast_guid (URL)        Set the episode's URL tag\n"
    "  --purchase_date (UTC)       Set time of purchase\n"
    "  --encoding_tool (string)    Set the name of the encoder\n"
    "  --encoded_by   (string)     Set the name of the Person/company who "
    "encoded the file\n"
    "  --ap_id        (string)     Set the Account Name\n"
    "  --cn_id        (number)     Set the iTunes Catalog ID (see --longhelp)\n"
    "  --ge_id        (number)     Set the iTunes Genre ID (see --longhelp)\n"
    "  --x_id         (string)     Set the vendor-supplied iTunes xID (see "
    "--longhelp)\n"
    "  --gapless      (boolean)    Set the gapless playback flag\n"
    "  --content_rating (string*)  Set tv/mpaa rating (see --r_dns_help)\n"
    "\n"
    "Deleting tags\n"
    "  Set the value to \"\":        --artist \"\" --stik \"\" --bpm \"\"\n"
    "  To delete (all) artwork:    --artwork REMOVE_ALL\n"
    "  manually removal:           --manual_atom_remove "
    "\"moov.udta.meta.ilst.ATOM\"\n"
    "\n"
    "More detailed iTunes help is available with AtomicParsley --longhelp\n"
    "Setting reverse DNS forms for iTunes files: see --reverse_dns_help\n"
    "Setting 3gp assets into 3GPP & derivative files: see --3gp_help\n"
    "Setting copyright notices for all files: see --iso_help\n"
    "For file-level options & padding info: see --file_help\n"
    "Setting custom private tag extensions: see --uuid_help\n"
    "Setting ID3 tags onto mpeg-4 files: see --id3_help\n"
    "\n"
    "----------------------------------------------------------------------";
...
static const char *longHelp_text =
    ...
    "files. \n"
    "              (3gp help available with AtomicParsley --3gp_help)\n"
    "          (ISO copyright help available with AtomicParsley --iso_help)\n"
    ...
    "example: AtomicParsley /path/to.mp4 --podcast_url \"http://www.url.net\" "
    "--tracknum 45/356\n"
    "example: AtomicParsley /path/to.mp4 --copyright \"\342\204\227 \302\251 "
    "2006\"\n"
    "example: AtomicParsley /path/to.mp4 --date \"2006-07-27T14:00:43Z\" "
    "--purchaseDate timestamp\n"
    "example: AtomicParsley /path/to.mp4 --sort_order artist \"Mighty Dub Cats, "
    "The\n"
    "--------------------------------------------------------------------------"
    "----------------------\n"
    "  Extract any pictures in user data \"covr\" atoms to separate files. \n"
    "  --extract_pix         ,  -E                    Extract to same folder "
    "(basename derived from file).\n"
    "  --extract_pix_to_path ,  -e  (/path/basename)  Extract to specific path "
    ...
    "  --lyrics_file      ,       (/path)  Set the lyrics tag to the content "
    "of a file\n"
    ...
    "  --album_artist     ,  -A   (str)    Set the album artist tag: "
    ...
    "on the \"sdes\" atom\n"
    "  --tv_network       ,  -n   (str)    Sets the TV Network name on the "
    "\"tvnn\" atom\n"
    "  --tv_show_name     ,  -H   (str)    Sets the TV Show name on the "
    "\"tvsh\" atom\n"
    "  --tv_episode       ,  -I   (str)    Sets the TV Episode on "
    "\"tven\":\"209\", but it is a string: \"209 Part 1\"\n"
    "  --tv_season_num    ,  -U   (num)    Sets the TV Season number on the "
    "\"tvsn\" atom\n"
    "  --tv_episode_num   ,  -N   (num)    Sets the TV Episode number on the "
    "\"tves\" atom\n"
    ...
    "to MacOSX Spotlight\n"
    "  --podcast_url      ,  -L   (URL)    Set the podcast feed URL on the "
    "\"purl\" atom\n"
    "  --podcast_guid     ,  -J   (URL)    Set the episode's URL tag on the "
    "\"egid\" atom\n"
    "  --purchase_date    ,  -D   (UTC)    Set Universal Coordinated Time of "
    "purchase on a \"purd\" atom\n"
    "                                       (use \"timestamp\" to set UTC to "
    "now; can be akin to id3v2 TDTG tag)\n"
    "  --encoding_tool    ,       (str)    Set the name of the encoder on the "
    "\"\302\251too\" atom\n"
    "  --encoded_by       ,       (str)    Set the name of the Person/company "
    "who encoded the file on the \"\302\251enc\" atom\n"
    "  --ap_id            ,  -Y   (str)    Set the name of the Account Name on "
    "the \"apID\" atom\n"
    "  --cn_id            ,       (num)    Set iTunes Catalog ID, used for "
    ...
    "\n"
    "  --ge_id            ,       (num)    Set iTunes Genre ID.  This does not "
    "necessarily have to match genre.\n"
    "                                      See --genre-movie-id-list and "
    "--genre_tv_id_list\n"
    "\n"
    "  --x_id             ,       (str)    Set iTunes vendor-supplied xID, "
    ...
    "  --sort_order   (type)      (str)    Sets the sort order string for that "
    "type of tag.\n"
    ...
    "  --artist \"\" --lyrics \"\"\n"
    "  --artwork REMOVE_ALL \n"
    "  --purge_metadata   ,  -P            Douches away every atom under "
    "\"moov.udta.meta.ilst\" \n"
    "  --purge_foobar2000 ,  -2            Eliminates foobar2000's "
    "non-compliant so-out-o-spec tagging scheme\n"
    "  --manual_atom_remove \"some.atom.path\" where some.atom.path can be:\n"
...
static const char *fileLevelHelp_text =
    ...
    "dates\n"
    "\n"
    "  --text_data        ,  -t      print user data text metadata relevant to "
    ...
    "\n"
    "  --prevent_optimizing                Prevents reorganizing the file to "
    ...
    "--over_write, files with metadata at the end\n"
    ...
    "place (--over_write forced),\n"
    "                                      but will also keep the original "
    "file's timestamps intact.\n"
    "\n"
#endif
    "  --deep_scan                         Parse areas of the file that are "
    "normally skipped (must be the 3rd arg)\n"
    "  --ipod_uuid                (num)    Place the ipod-required uuid for "
    ...
    "\"--deep_scan\" option as the 3rd cli argument\n"
    ...
    "  AP /path/to/file.m4v --deep_scan --ipod_uuid 1200\n"
    ...
    "      unless given the --over_write flag when if possible, utilizing "
...
static const char *_3gpHelp_text =
    ...
    "  For tags that support the language attribute (all except date), more "
    ...
    "[brackets]\n"
    "\n"
    "  --3gp_title           (str)  [lang=3str]  [UTF16]  [area]  .........  "
    "Set a 3gp media title tag\n"
    "  --3gp_author          (str)  [lang=3str]  [UTF16]  [area]  .........  "
    "Set a 3gp author of the media tag\n"
    "  --3gp_performer       (str)  [lang=3str]  [UTF16]  [area]  .........  "
    "Set a 3gp performer or artist tag\n"
    "  --3gp_genre           (str)  [lang=3str]  [UTF16]  [area]  .........  "
    "Set a 3gp genre asset tag\n"
    "  --3gp_description     (str)  [lang=3str]  [UTF16]  [area]  .........  "
    "Set a 3gp description or caption tag\n"
    "  --3gp_copyright       (str)  [lang=3str]  [UTF16]  [area]  .........  "
    "Set a 3gp copyright notice tag*\n"
    "\n"
    "  --3gp_album           (str)  [lang=3str]  [UTF16]  [trknum=int] [area]  "
    "Set a 3gp album tag (& opt. tracknum)\n"
    "  --3gp_date            (int)  [area]  ...........................  Set a "
    "3gp recording date tag (4 digit only)\n"
    "\n"
    "  --3gp_rating          (str)  [entity=4str]  [criteria=4str]  "
    "[lang=3str]  [UTF16]  [area]   Rating tag\n"
    "  --3gp_classification  (str)  [entity=4str]  [index=int]      "
    "[lang=3str]  [UTF16]  [area]   Classification\n"
    "\n"
    "  --3gp_keyword         (str)   [lang=3str]  [UTF16]  [area]   Format of "
    "str: 'keywords=word1,word2,word3,word4'\n"
    "\n"
    "  --3gp_location        (str)   [lang=3str]  [UTF16]  [area]   Set a 3gp "
    ...
    "example: Atomicparsley /path/to.3gp --3gp_performer \"Enjoy Yourself\" "
    "lang=pol UTF16\n"
    "example: Atomicparsley /path/to.3gp --3gp_date 2006 --3gp_album \"White "
    "Label\" track=8 lang=fra\n"
    "example: Atomicparsley /path/to.3gp --3gp_album \"Cow Cod Soup For "
    "Everyone\" track=10 lang=car\n"
    "\n"
    "example: Atomicparsley /path/to.3gp --3gp_classification \"Poor Sport\" "
    "entity=\"PTA \" index=12 UTF16\n"
    "example: Atomicparsley /path/to.3gp --3gp_keyword "
    "keywords=\"foo1,foo2,foo 3\" UTF16 --3gp_keyword \"\"\n"
    "example: Atomicparsley /path/to.3gp --3gp_location 'Bethesda Terrace' "
    "latitude=40.77 longitude=73.98W \n"
    "                                                    altitude=4.3B "
    "role='real' body=Earth notes='Underground'\n"
    "\n"
    "example: Atomicparsley /path/to.3gp --3gp_title \"I see London.\" "
    "--3gp_title \"Veo Madrid.\" lang=spa \n"
    "                                    --3gp_title \"Widze Warsawa.\" "
    "lang=pol\n"
    "\n";
...
static const char *ISOHelp_text =
    ...
    "  3GP-style copyright. In fact, using --iso_copyright can potentially "
    ...
    "  able languages use \"AtomicParsley --language_list\". Notices can be "
    "set in utf8 or utf16.\n"
    "\n"
    "  --iso_copyright  (str)  [movie|track|track=#]  [lang=3str]  [UTF16]   "
    ...
    "example: AtomicParsley /path/file.mp4 --iso_copyright \"Sample\"\n"
    "example: AtomicParsley /path/file.mp4 --iso_copyright \"Sample\" movie\n"
    "example: AtomicParsley /path/file.mp4 --iso_copyright \"Sample\" track=2 "
    "lang=urd\n"
    "example: AtomicParsley /path/file.mp4 --iso_copyright \"Sample\" track "
    "UTF16\n"
    "example: AP --iso_copyright \"Example\" track --iso_copyright \"Por "
    "Exemplo\" track=2 lang=spa UTF16\n"
    "\n"
    "Note: to remove the copyright, set the string to \"\" - the track and "
    "language must match the target.\n"
    "example: --iso_copyright \"\" track --iso_copyright \"\" track=2 "
    "lang=spa\n"
    "\n"
...
static const char *uuidHelp_text =
    ...
    "  --meta_uuid        There are two forms: 1 for text & 1 for file "
    "operations\n"
    "         setting text form:\n"
    "         --meta_uuid   (atom) \"text\" (str)         \"atom\" = 4 "
    "character atom name of your choice\n"
    "                                                     str is whatever text "
    "you want to set\n"
    "         file embedding form:\n"
    "         --meta_uuid   (atom) \"file\" (/path) [description=\"foo\"] "
    "[mime-type=\"foo/moof\"]\n"
    "                                                     \"atom\" = 4 "
    "character atom name of your choice\n"
    "                                                     /path = path to the "
    ...
    "  --meta_uuid tagr text \"Johnny Appleseed\" --meta_uuid \302\251sft text "
    "\"OpenShiiva encoded.\"\n"
    "  --meta_uuid scan file /usr/pix/scans.zip\n"
    "  --meta_uuid 1040 file ../../2006_taxes.pdf description=\"Fooled 'The "
    "Man' yet again.\"\n"
    "can be removed with:\n"
    "  --tagtime \"\" --information \"\"  --url \" \"  --meta_uuid scan file "
    "\n"
    "  --manual_atom_remove "
    ...
    "  --manual_atom_remove "
    "moov.trak[2].uuid=55534d54-21d2-4fce-bb88-695cfac9c740 \\\n"
    "  --manual_atom_remove uuid=50524f46-21d2-4fce-bb88-695cfac9c740\n"
    "\n"
    "Viewing the contents of uuid atoms:\n"
    "  -t or --textd_ata           Shows the uuid atoms (both text & file) that "
    "AP sets:\n"
    "  Example output:\n"
    ...
    "  --extract_1_uuid      (atom)           Extract file embedded within "
...
static const char *rDNSHelp_text =
    ...
    "\n"
    "  --content_rating (rating)            Set the US TV/motion picture media "
    "content rating\n"
    "                                         for available ratings use "
    "\"AtomicParsley --ratings_list\n"

    "  --r_dns_atom      (str)   name=(name_str) domain=(reverse_domain)  "
    ...
    " Examples:\n"
    "  --content_rating \"NC-17\" --contentRating \"TV-Y7\"\n"
    "  --r_dns_atom \"mpaa|PG-13|300|\" name=iTunEXTC domain=com.apple.iTunes\n"
    "  --content_rating \"\"\n"
    "  --r_dns_atom \"\" name=iTunEXTC domain=com.apple.iTunes\n"
    "  --r_dns_atom \"try1\" name=EVAL domain=org.fsf --r_dns_atom \"try 2\" "
    "name=EVAL domain=org.fsf\n"
    "  --r_dns_atom \"\" name=EVAL domain=org.fsf\n"
    "--------------------------------------------------------------------------"
    "--------------------------\n";
...
static const char *ID3Help_text =
    ...
    "       --id3_tag COMM \"Primary\" --desc=AAA --id3_tag COMM \"El Segundo\" "
    "UTF16LE lang=spa --desc=AAA\n"
    " See available frames with \"AtomicParsley --id3_frames_list\"\n"
    " See avilable imagetypes with \"AtomicParsley --imagetype_list\"\n"
    "\n"
    ...
    "--------------------------\n"
    " Usage:\n"
    "  --id3_tag (frameID or alias) (str) [desc=(str)] [mimetype=(str)] "
    ...
    "\n"
    " Examples:\n"
    " --id3_tag APIC /path/to/img.ext\n"
    " --id3_tag APIC /path/to/img.ext desc=\"something to say\" imagetype=0x08 "
    "UTF16LE compressed\n"
    " --id3_tag composer \"I, Claudius\" --id3_tag TPUB \"Seneca the Roman\" "
    "--id3_tag TMOO Imperial\n"
    " --id3_tag UFID look@me.org uniqueID=randomUUIDstamp\n"
    "\n"
    " Extracting embedded images in APIC frames:\n"
    " --id3_tag APIC extract\n"
...
int real_main(int argc, char *argv[]) {
  if (argc == 1) {
    ...
    } else if ((strcmp(argv[1], "--3gp_help") == 0) ||
               (strcmp(argv[1], "-3gp_help") == 0) ||
               (strcmp(argv[1], "--3gp_h") == 0)) {
      fprintf(stdout, "%s\n", _3gpHelp_text);
      exit(0);

    } else if ((strcmp(argv[1], "--iso_help") == 0) ||
               (strcmp(argv[1], "-iso_help") == 0) ||
               (strcmp(argv[1], "-Ih") == 0)) {
      fprintf(stdout, "%s\n", ISOHelp_text);
      exit(0);

    } else if ((strcmp(argv[1], "--file_help") == 0) ||
               (strcmp(argv[1], "-file_help") == 0) ||
               (strcmp(argv[1], "-fh") == 0)) {
      fprintf(stdout, "%s\n", fileLevelHelp_text);
      exit(0);

    } else if ((strcmp(argv[1], "--uuid_help") == 0) ||
               (strcmp(argv[1], "-uuid_help") == 0) ||
               (strcmp(argv[1], "-uh") == 0)) {
      fprintf(stdout, "%s\n", uuidHelp_text);
      exit(0);

    } else if ((strcmp(argv[1], "--reverse_dns_help") == 0) ||
               (strcmp(argv[1], "-r_dns_help") == 0) ||
               (strcmp(argv[1], "-rh") == 0)) {
      fprintf(stdout, "%s\n", rDNSHelp_text);
      exit(0);

    } else if ((strcmp(argv[1], "--id3_help") == 0) ||
               (strcmp(argv[1], "-id3_help") == 0) ||
               (strcmp(argv[1], "-id3h") == 0)) {
      fprintf(stdout, "%s\n", ID3Help_text);
      exit(0);

    } else if (strcmp(argv[1], "--genre_list") == 0) {
      ListGenresValues();
      exit(0);

    } else if (strcmp(argv[1], "--stik_list") == 0) {
      ListStikValues();
      exit(0);

    } else if (strcmp(argv[1], "--language_list") == 0 ||
               strcmp(argv[1], "--languages_list") == 0 ||
               strcmp(argv[1], "--list_language") == 0 ||
               strcmp(argv[1], "--list_languages") == 0 ||
               strcmp(argv[1], "-ll") == 0) {
      ListLanguageCodes();
      exit(0);

    } else if (strcmp(argv[1], "--ratings_list") == 0) {
      ListMediaRatings();
      exit(0);

    } else if (strcmp(argv[1], "--genre_movie_id_list") == 0) {
      ListMovieGenreIDValues();
      exit(0);

    } else if (strcmp(argv[1], "--genre_tv_id_list") == 0) {
      ListTVGenreIDValues();
      exit(0);

    } else if (strcmp(argv[1], "--id3_frames_list") == 0) {
      ListID3FrameIDstrings();
      exit(0);

    } else if (strcmp(argv[1], "--imagetype_list") == 0) {
  ...
  if (argc > 3 && strcmp(argv[2], "--deep_scan") == 0) {
    deep_atom_scan = true;
  ...
  while (1) {
    static struct option long_options[] = {
      ...
      {"text_data", optional_argument, NULL, OPT_ShowTextData},
      {"extract_pix", 0, NULL, OPT_ExtractPix},
      {"extract_pix_to_path", required_argument, NULL, OPT_ExtractPixToPath},
      {"artist", required_argument, NULL, Meta_artist},
      {"art_director", required_argument, NULL, Meta_artDirector},
      ...
      {"original_artist", required_argument, NULL, Meta_originalArtist},
      {"producer", required_argument, NULL, Meta_producer},
      //        { "performer",        required_argument,  NULL, Meta_performer
      //        },
      {"sound_engineer", required_argument, NULL, Meta_soundEngineer},
      {"soloist", required_argument, NULL, Meta_soloist},
      {"executive_producer", required_argument, NULL, Meta_executiveProducer},
      ...
      {"disc", required_argument, NULL, Meta_disknum},
      {"comment", required_argument, NULL, Meta_comment},
      {"date", required_argument, NULL, Meta_year},
      {"lyrics", required_argument, NULL, Meta_lyrics},
      {"lyrics_file", required_argument, NULL, Meta_lyrics_file},
      ...
      {"album_artist", required_argument, NULL, Meta_album_artist},
      ...
      {"tv_network", required_argument, NULL, Meta_TV_Network},
      {"tv_show_name", required_argument, NULL, Meta_TV_ShowName},
      {"tv_episode", required_argument, NULL, Meta_TV_Episode},
      {"tv_episode_num", required_argument, NULL, Meta_TV_EpisodeNumber},
      {"tv_season_num", required_argument, NULL, Meta_TV_SeasonNumber},
      {"podcast_flag", required_argument, NULL, Meta_podcastFlag},
      {"keyword", required_argument, NULL, Meta_keyword},
      {"category", required_argument, NULL, Meta_category},
      {"podcast_url", required_argument, NULL, Meta_podcast_URL},
      {"podcast_guid", required_argument, NULL, Meta_podcast_GUID},
      {"purchase_date", required_argument, NULL, Meta_PurchaseDate},
      {"encoding_tool", required_argument, NULL, Meta_EncodingTool},
      {"encoded_by", required_argument, NULL, Meta_EncodedBy},
      {"ap_id", required_argument, NULL, Meta_apID},
      {"cn_id", required_argument, NULL, Meta_cnID},
      {"ge_id", required_argument, NULL, Meta_geID},
      {"x_id", required_argument, NULL, Meta_xID},
      {"gapless", required_argument, NULL, Meta_PlayGapless},
      {"sort_order", required_argument, NULL, Meta_SortOrder},

      {"r_dns_atom", required_argument, NULL, Meta_ReverseDNS_Form},
      {"content_rating", required_argument, NULL, Meta_rDNS_rating},
      ...
      {"meta_uuid", required_argument, NULL, Meta_uuid},
      {"extract_uuids", optional_argument, NULL, Opt_Extract_all_uuids},
      {"extract_1_uuid", required_argument, NULL, Opt_Extract_a_uuid},
      {"ipod_uuid", required_argument, NULL, Opt_Ipod_AVC_uuid},

      {"freefree", optional_argument, NULL, Opt_FreeFree},
      {"purge_metadata", 0, NULL, Metadata_Purge},
      {"manual_atom_remove", required_argument, NULL, Manual_atom_removal},
      {"purge_user_data", 0, NULL, UserData_Purge},
      {"purge_foobar2000", 0, NULL, foobar_purge},
      {"dump_metadata", 0, NULL, Meta_dump},
      {"output", required_argument, NULL, OPT_OutputFile},
      {"prevent_optimizing", 0, NULL, OPT_NoOptimize},
      {"over_write", 0, NULL, OPT_OverWrite},
#if defined(_WIN32)
      {"preserve_time", 0, NULL, OPT_PreserveTimeStamps},
#endif
      {"iso_copyright", required_argument, NULL, ISO_Copyright},

      {"3gp_title", required_argument, NULL, _3GP_Title},
      {"3gp_author", required_argument, NULL, _3GP_Author},
      {"3gp_performer", required_argument, NULL, _3GP_Performer},
      {"3gp_genre", required_argument, NULL, _3GP_Genre},
      {"3gp_description", required_argument, NULL, _3GP_Description},
      {"3gp_copyright", required_argument, NULL, _3GP_Copyright},
      {"3gp_album", required_argument, NULL, _3GP_Album},
      {"3gp_date", required_argument, NULL, _3GP_Year},

      {"3gp_rating", required_argument, NULL, _3GP_Rating},
      {"3gp_classification", required_argument, NULL, _3GP_Classification},
      {"3gp_keyword", required_argument, NULL, _3GP_Keyword},
      {"3gp_location", required_argument, NULL, _3GP_Location},

      {"id3_tag", required_argument, NULL, Meta_ID3v2Tag},

      {"deep_scan", 0, &extr, 1},
      {"movement_count", required_argument, NULL, Meta_movementCount},
      {"movement_name", required_argument, NULL, Meta_movementName},
      {"movement_number", required_argument, NULL, Meta_movementNumber},
      {"show_work_movement", required_argument, NULL, Meta_showWorkMovement},
    ...
    case Meta_year: {
      APar_ScanAtoms(ISObasemediafile);
      if (!APar_assert(metadata_style == ITUNES_STYLE, 1, "date")) {
        break;
      }
